...
C.pinSchema = {
  ...
  { dir = 'in', type = 'bool', name = 'useWaypointAudio', default = true, description = 'If a sound should be played when the car passes through a waypoint.'},
...
function C:work(args)
  ...
  if self.pinIn.flow.value then
    if not self.started then
      ...
      self.race.useWaypointAudio = self.pinIn.useWaypointAudio.value
