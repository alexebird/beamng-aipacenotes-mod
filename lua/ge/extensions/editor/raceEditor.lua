...
local function onEditorInitialized()
  ...
  table.insert(windows, require('/lua/ge/extensions/editor/raceEditor/pacenotes')(M)) -- 4
  -- table.insert(windows, require('/lua/ge/extensions/editor/raceEditor/aiPacenotes')(M)) -- 5
  table.insert(windows, require('/lua/ge/extensions/editor/raceEditor/trackLayout')(M)) -- 5
  table.insert(windows, require('/lua/ge/extensions/editor/raceEditor/timeTrials')(M)) -- 6
  table.insert(windows, require('/lua/ge/extensions/editor/raceEditor/tools')(M)) -- 7
